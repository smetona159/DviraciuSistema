...
function displayUsers() {
    ...
    echo "<tr><td><b>Užsakymo ID</b></td><td><b>Užsakymo suma</b></td><td><b>Užsakymo data</b></td><td><b>Būklė:</b></td><td><b>Užsakovas</b></td><td><b>Veiksmai:</b></td></tr>\n";
    ...
    for ($i = 0; $i < $num_rows; $i++) {
      $id = mysqli_result($result, $i, "id");
        ...
        echo "<tr><td>$id</td><td>$suma</td><td>$data</td><td>$pakeistiBusena</td><td>$uzsakovas</td><td>$trinti</td></tr>\n";
  }
    echo "</table><br>\n";
}
